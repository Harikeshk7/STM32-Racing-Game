...
void init_dac(void)
{
    ...
    RCC->AHBENR |= RCC_AHBENR_GPIOAEN; // DO I NEED THIS?
    GPIOA->MODER |= 0x300; // ANALOG OUTPUT PA4
...
void init_tim6(void)
{
    // TODO: you fill this in.
    int psc_val = 480;
    int arr_val = 100000 / (RATE); // HOW DO I MAKE THIS BETTER?
...
void init_tim2(int n) {
    ...
    NVIC->ISER[0] |= 1<<TIM2_IRQn; // SET TO LOW PRIORITY?
}
